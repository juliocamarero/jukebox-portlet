 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ArtistModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ArtistImpl}.
 * </p>
 *
...
public class ArtistModelImpl extends BaseModelImpl<Artist>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(org.liferay.jukebox.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.org.liferay.jukebox.model.Artist"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(org.liferay.jukebox.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.org.liferay.jukebox.model.Artist"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(org.liferay.jukebox.service.util.PropsUtil.get(
	...
	public static final long ARTISTID_COLUMN_BITMASK = 64L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(org.liferay.jukebox.service.util.PropsUtil.get(
	...
	public void resetOriginalValues() {
		...
		artistModelImpl._setModifiedDate = false;
	...
	private static final ClassLoader _classLoader = Artist.class.getClassLoader();
